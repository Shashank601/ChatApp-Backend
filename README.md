...
This repository is kept only for personal reference.  
The project does work, but some parts of the UI were generated using ai, so this is not something I claim as a fully self-crafted product.
